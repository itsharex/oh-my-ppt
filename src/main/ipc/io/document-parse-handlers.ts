...
const normalizeGeneratedPlan = (
  ...
  const pageCount = hasExplicitPageCount
    ? normalizedPageCount
    : impliedPageCount >= 2
      ? impliedPageCount
      : normalizedPageCount
...
const buildDocumentPlanPrompt = (args: {
  ...
  [
    ...
    args.pageCount
      ...
      : '- No page count was provided. Infer pageCount from the document structure and information density.',
    '',
