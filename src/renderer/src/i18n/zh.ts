export const zh = {
  ...
  templates: {
    ...
    uploadDocumentTooltip: '支持 txt、md、csv、docx（≤{maxSize}MB）。上传后的资料会作为生成的重要来源参考。',
    analyzeDocument: '解析大纲',
    analyzeDocumentTooltip: '调用所选模型分析参考文档，并生成标题、页数和大纲建议；解析结果会写入当前表单。',
  ...
  home: {
    ...
    uploadReferenceTooltip:
      '支持 txt、md、csv、docx（≤{maxSize}MB），以及 png、jpg、webp 图片（≤{imageMaxSize}MB）。上传后的资料会作为生成的重要来源参考。',
