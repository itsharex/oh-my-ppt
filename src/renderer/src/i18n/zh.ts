export const zh = {
  ...
  settings: {
    ...
    imageModelConfigHint:
      '按 provider 填完整 JSON。Agnes 示例：{"model":"agnes-image-2.0-flash","apiKey":"...","responseFormat":"url"}；即梦3.0 示例：{"reqKey":"jimeng_t2i_v30","accessKeyId":"...","secretKey":"..."}；即梦4.0 示例：{"reqKey":"jimeng_t2i_v40","accessKeyId":"...","secretKey":"...","force_single":true}。',
    ...
    imageModelPlaceholder: '例如：即梦3.0 / 即梦4.0 / Agnes AI',
    imageModelNamePlaceholder: '例如：即梦3.0 / 即梦4.0 / Agnes AI',
    baseUrlPlaceholder: '例如：https://api.deepseek.com',
    imageBaseUrlPlaceholder: '留空使用内置默认地址，或填写兼容服务地址',
    imageBaseUrlHint: '目前只开放即梦3.0、即梦4.0 和 Agnes AI；自定义网关后续单独接入。',
...
- 不要出现闪烁或大范围抖动的动画效果`
  ...
  sessionDetail: {
    ...
    imageOutlineConstraints: '不要生成可读文字、logo、水印或假图表标签，画面需适合 16:9 幻灯片排版并留出文字空间。',
    editText: '编辑文字',
    exitTextEdit: '退出编辑',
    previewMode: '预览模式',
    editMode: '编辑模式',
